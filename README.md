...
1. 任意のフォルダでプロジェクトをクローンする
  ```cmd
  > git clone https://github.com/shibamirai/katachi-blog-django6.git
  > chdir katachi-blog-django6
  ```
...
1. 必要な Python パッケージと Django-Tailwind で必要な Node パッケージをインストールする
  ```cmd
